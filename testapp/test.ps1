...
.\build.ps1 -semver 0.0.0 -uind 1 -channel dev -notes "The first commit (dev)" -auto -noCrossCompile -addDeploy .\deploy.json -deployURL "https://raw.githubusercontent.com/sbamboo/go-framework/refs/heads/main/testapp/deploy.json" -ghUpMetaRepo "sbamboo/go-framework" -withDebugger
...
.\build.ps1 -semver 0.0.1 -uind 3 -channel dev -notes "The second commit (dev)" -auto -noCrossCompile -addDeploy .\deploy.json -deployURL "https://raw.githubusercontent.com/sbamboo/go-framework/refs/heads/main/testapp/deploy.json" -ghUpMetaRepo "sbamboo/go-framework" -withDebugger
